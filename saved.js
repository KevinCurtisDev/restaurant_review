...
navigator.geolocation.getCurrentPosition(function (location) {
    ...
    fetch("/data/data.json")
        ...
        .then(function (data) {
            ...
            //add reviews to existing restaurant listing
    ...
    fetch("https://developers.zomato.com/api/v2.1/geocode?lat=" + location.coords.latitude + "&lon+=" + location.coords.longitude, {
        ...
        .then(function (zomatoData) {
            ...
            for (let i = 0; i < zomatoData.nearby_restaurants.length; i++) {
                console.log("Name " + zomatoData.nearby_restaurants[i].restaurant.name,
                    "Rating " + zomatoData.nearby_restaurants[i].restaurant.user_rating.aggregate_rating
                )
                ...
                restaurantsList.append(zomatohtml);
            }
